...
const ShopDetails = () => {
  ...
  const getShop = (shopId: string) => {
    ShopService.getShop(shopId).then((res) => {
      const sortedOpeningHours = [...res.data.openingHours].sort((a, b) => a.day - b.day);
      setShop({ ...res.data, openingHours: sortedOpeningHours });
    });
  };
  ...
  return (
    ...
    >
      ...
      <Typography variant="h6" sx={{ mt: 0.5 }}>
        Catégories distinctes : {shop.nbDistinctCategories}
      </Typography>
      <Typography sx={{ my: 1 }}>
